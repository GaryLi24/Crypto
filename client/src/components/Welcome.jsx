...
const Welcome = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div
        className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4"
        style={{ padding: '7rem' }}
      >
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p
            ...
            style={{ lineHeight: '3rem', fontSize: '18px' }}
          >
            这是一个 Web3.0 区块链的应用,
            通过智能合约、加密货币实现了在以太坊测试网 Georli
            上进行不同账户货币交易。 <br />
            <br />
            This is a Modern Web 3.0 Blockchain App <br /> Solidity, Smart
            Contracts, Crypto
          </p>
          {!currentAccount && (
            <button
